...
% TODO ^ move this maybe, add more approaches to sequential pattern mining maybe ^
% TODO cite hidden markov models introduction maybe
...
% At the end of that chapter we will look into a number of \emph{interestingness measures}: how interesting is a pattern in an event sequence?
