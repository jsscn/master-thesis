...
We will begin by defining the form of a data set in our setting---\emph{event sequences}. Then we will move on to \emph{patterns}---how to define a pattern on an event sequence. At the end of this chapter we will look into the \emph{interestingness measures} we will implement---how interesting is a pattern in an event sequence.
