...
A drawback of the disjoint-window frequency, similarly to the fixed-window frequecy, is that it will disadvantage large episodes more so than the disjoint-window frequency, because generally, larger episodes naturally require larger --- less-weighted --- windows.
