...
Figure~\ref{fig:candidates-trains-900} provides some insight: the number of candidates shows a very similar progression as the runtime. So the runtime seems to be closely related to the number of candidates.
...
\end{axis}
\end{tikzpicture}
\caption{The number of frequent $ l $-episodes as a function of the frequency threshold. Not all episode sizes, and only parallel episodes.}
...
\caption{Runtimes for finding association rules from episodes generated from \emph{tolstoy} as a function of the number of frequent episodes.}
...
\caption{Runtimes for finding association rules from episodes generated from \emph{trains} as a function of the number of frequent episodes.}
