...
% TODO add more frequency measures
...
% TODO analyze 2-episodes and 3-episodes
...
We can make some more observations about the plots in figure~\ref{fig:episodes-frequencies-by-size}. % oh yeah? we'll see about that
...
Table~\ref{table:compare-top-episodes} shows the 15 most frequent parallel episodes by the disjoint-window frequency, and the 15 most cohesive patterns mined from \textsc{Fci}.
