...
% TODO consider putting this somewhere
\iffalse
...
\addplot table [x=frequency-threshold,y=num-frequent-1-episodes] {experiments/trains/trains-serial-fixed-windows-900.tsv};
\addplot table [x=frequency-threshold,y=num-frequent-2-episodes] {experiments/trains/trains-serial-fixed-windows-900.tsv};
\addplot table [x=frequency-threshold,y=num-frequent-3-episodes] {experiments/trains/trains-serial-fixed-windows-900.tsv};
\addplot table [x=frequency-threshold,y=num-frequent-4-episodes] {experiments/trains/trains-serial-fixed-windows-900.tsv};
\addplot table [x=frequency-threshold,y=num-frequent-5-episodes] {experiments/trains/trains-serial-fixed-windows-900.tsv};
\addplot table [x=frequency-threshold,y=num-frequent-6-episodes] {experiments/trains/trains-serial-fixed-windows-900.tsv};
\addplot table [x=frequency-threshold,y=num-frequent-7-episodes] {experiments/trains/trains-serial-fixed-windows-900.tsv};
\addplot table [x=frequency-threshold,y=num-frequent-8-episodes] {experiments/trains/trains-serial-fixed-windows-900.tsv};
\addplot table [x=frequency-threshold,y=num-frequent-9-episodes] {experiments/trains/trains-serial-fixed-windows-900.tsv};
\addplot table [x=frequency-threshold,y=num-frequent-10-episodes] {experiments/trains/trains-serial-fixed-windows-900.tsv};
\addplot table [x=frequency-threshold,y=num-frequent-11-episodes] {experiments/trains/trains-serial-fixed-windows-900.tsv};
\addplot table [x=frequency-threshold,y=num-frequent-12-episodes] {experiments/trains/trains-serial-fixed-windows-900.tsv};
\addplot table [x=frequency-threshold,y=num-frequent-13-episodes] {experiments/trains/trains-serial-fixed-windows-900.tsv};
\addplot table [x=frequency-threshold,y=num-frequent-14-episodes] {experiments/trains/trains-serial-fixed-windows-900.tsv};
\addplot table [x=frequency-threshold,y=num-frequent-15-episodes] {experiments/trains/trains-serial-fixed-windows-900.tsv};
...
\emph{trains} & $ 1\,280 $ & $ 10\,115 $ & $ 26\,626\,667 $ & sparse \\
...
\caption{The frequency of the event types in \emph{trains}.}
...
Figure~\ref{fig:investigate-trains-runtimes} provides some insight: the number of candidates shows a very similar progression as the runtime. So the runtime seems to be closely related to the number of candidates.
...
% \addplot table [x=frequency-threshold,y=num-frequent-6-episodes] {experiments/trains/trains-parallel-weighted-windows-900.tsv};
% \addplot table [x=frequency-threshold,y=num-frequent-7-episodes] {experiments/trains/trains-parallel-weighted-windows-900.tsv};
% \addplot table [x=frequency-threshold,y=num-frequent-8-episodes] {experiments/trains/trains-parallel-weighted-windows-900.tsv};
% \addplot table [x=frequency-threshold,y=num-frequent-9-episodes] {experiments/trains/trains-parallel-weighted-windows-900.tsv};
% \addplot table [x=frequency-threshold,y=num-frequent-10-episodes] {experiments/trains/trains-parallel-weighted-windows-900.tsv};
% \addplot table [x=frequency-threshold,y=num-frequent-11-episodes] {experiments/trains/trains-parallel-weighted-windows-900.tsv};
% \addplot table [x=frequency-threshold,y=num-frequent-12-episodes] {experiments/trains/trains-parallel-weighted-windows-900.tsv};
% \addplot table [x=frequency-threshold,y=num-frequent-13-episodes] {experiments/trains/trains-parallel-weighted-windows-900.tsv};
% \addplot table [x=frequency-threshold,y=num-frequent-14-episodes] {experiments/trains/trains-parallel-weighted-windows-900.tsv};
% \addplot table [x=frequency-threshold,y=num-frequent-15-episodes] {experiments/trains/trains-parallel-weighted-windows-900.tsv};
...
\end{subfigure}
\caption{Some more plots as a subject of investigation of the curious runtimes for the weighted windows in experiment in Figure~\ref{fig:runtimes-trains-900}.}
...
Besides episodes, we would also like to have a sense of the runtimes for association rules. All of the results shown in this section were generated during the experiments from Section~\ref{sec:performance-episodes}, so the same parameter configurations apply.
...
We think that there must be opportunities left for improving the performance of our implementation. We are not experts at optimizing code for speed, although we tried to do our best.
...
% TODO ^ include this or something similar, or not?
