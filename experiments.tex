...
\addplot table [x=num-frequent-episodes,y=num-candidates] {experiments/trains/trains-parallel-weighted-windows-900.tsv};
\addplot table [x=num-frequent-episodes,y=num-candidates] {experiments/trains/trains-serial-weighted-windows-900.tsv};

\end{axis}

\end{tikzpicture}
\caption{The number of candidates compared to the number of frequent episodes, for weighted windows in the experiment in figure~\ref{fig:runtimes-trains-900}.}
\label{fig:candidates-trains-900}
\end{figure}
